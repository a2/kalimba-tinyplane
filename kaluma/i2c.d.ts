declare module "i2c" {
    ...
    class I2C {
        ...
        memWrite(memAddress: number, data: Uint8Array | string, address: number, memAddr16bit?: 0 | 1, timeout?: number, count?: number): number
        memRead(memAddress: number, length: number, address: number, memAddr16bit?: 0 | 1, timeout?: number): Uint8Array | null
        close(): void
    }
}
