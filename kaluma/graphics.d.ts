declare module "graphics" {
  ...
  class GraphicsContext {
    constructor(width: number, height: number, options?: GraphicsContextOptions)
    getWidth(): number
    getHeight(): number
    clearScreen(): void
    ...
    drawBitmap(x: number, y: number, bitmap: GraphicsBitmap, options?: GraphicsBitmapDrawingOptions): void
  }
  ...
  class BufferedGraphicsContext extends GraphicsContext {
    constructor(width: number, height: number, options?: BufferedGraphicsContextOptions)
    buffer: Uint8Array
    display(): void
  }
}
